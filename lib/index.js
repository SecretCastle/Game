...
require(['Weapon',"Bullet","Obstacle","WeaBulet","Utils"],function(Weapon,Bullet,Obstacle,WeaBulet,Utils){
    /**
     * init function
     */
    (function(GMS){
        ...
        // }
        // function initBullet(){
        //     gb.bullet_obj = new Bullet(10,100);
        //     gb.bullet_obj.create(gb.ctx);
        // }
        //
        // initTank();
        // initBullet();
